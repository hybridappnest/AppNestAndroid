...
/**
 * Created on 2020/9/24 18:54.
 * @author:hanxueqiang
 * @version: 1.0.0
 * @desc:
 */
class FilterHttpLoggingInterceptor @JvmOverloads constructor(
    private val logger: Logger = Logger.DEFAULT,
    private val mFilterUrls: List<String>? = null,
    ) : Interceptor {
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        try {
            ...
            logger.log("<-- HTTP FAILED: $e request:${request.url}")
            throw e
        }
