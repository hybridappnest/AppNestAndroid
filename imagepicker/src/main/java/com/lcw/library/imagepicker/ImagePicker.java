...
import com.ymy.image.imagepicker.activity.ImagePickerActivity;
...
public class ImagePicker {
    ...
    public void setCameraViewCallBack(CameraView view) {
        getInstance().mCameraView = view;
    }
     ...
     * @return
     */
    public ImagePicker needWatermark(boolean needWatermark) {
        ConfigManager.getInstance().setNeedWatermark(needWatermark);
        return mImagePicker;
    }
    ...
    public interface CameraView {
         ...
         * 跳转到拍摄界面
         */
        void goCameraView(Context context, int type, CameraViewCallBack callBack);
    }
