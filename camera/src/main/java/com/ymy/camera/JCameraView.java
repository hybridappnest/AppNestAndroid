...
import com.ymy.camera.listener.CaptureListener;
import com.ymy.camera.listener.ClickListener;
import com.ymy.camera.listener.JCameraErrorListener;
import com.ymy.camera.listener.JCameraListener;
import com.ymy.camera.listener.TypeListener;
import com.ymy.camera.state.CameraMachine;
import com.ymy.camera.view.CameraView;
...
public class JCameraView extends FrameLayout implements CameraInterface.CameraOpenOverCallback,
    ...
    public JCameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mContext = context;
        //get AttributeSet
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.JCameraView,
                defStyleAttr, 0);
    ...
    private void initData() {
        ...
        Logger.i(TAG, "zoom = " + zoomGradient);
    ...
    public void onResume() {
        Logger.i(TAG, "JCameraView onResume");
    ...
    public void resetState(int type) {
        switch (type) {
            case TYPE_VIDEO:
                ...
                mVideoView.setLayoutParams(new LayoutParams(LayoutParams.MATCH_PARENT,
    ...
    public void startPreviewCallback() {
        Logger.i(TAG, "startPreviewCallback");
    ...
    public boolean handlerFoucs(float x, float y) {
        ...
        ObjectAnimator alpha = ObjectAnimator.ofFloat(mFoucsView, "alpha", 1f, 0.4f, 1f, 0.4f, 1f
                , 0.4f, 1f);
    ...
    //生命周期onPause
    public void onPause() {
        Logger.i(TAG, "JCameraView onPause");
        stopVideo();
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        Logger.i(TAG, "JCameraView SurfaceCreated");
        new Thread() {
            @Override
            public void run() {
    ...
    public void surfaceDestroyed(SurfaceHolder holder) {
        Logger.i(TAG, "JCameraView SurfaceDestroyed");
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (event.getPointerCount() == 2) {
                    ...
                    float result =
                            (float) Math.sqrt(Math.pow(point_1_X - point_2_X, 2) + Math.pow(point_1_Y -
                                    point_2_Y, 2));
    ...
    //启动Camera错误回调
    public void setErrorLisenter(JCameraErrorListener errorLisenter) {
