...
public interface IPhotoView {
     ...
     * @param dFocalY
     */
    void zoomTo(float sFocalX, float sFocalY, float dScale, float dFocalX, float dFocalY);

    void zoomTo(float scale, float focalX, float focalY, PhotoViewAttacher.OnZoomEndListener l);
}
