...
public class MessageAudioLeftHolder extends MessageContentHolder {
    private static final int AUDIO_MIN_WIDTH = ScreenUtil.getPxByDp(70);
    ...
    public MessageAudioLeftHolder(View itemView) {
        super(itemView);
    }

    @Override
    public int getVariableLayout() {
        return R.layout.message_adapter_content_left_audio;
    }
    ...
    public void initVariableViews() {
        ...
        msg_body_tv = rootView.findViewById(R.id.msg_body_tv);
    }
    ...
    public void layoutVariableViews(final MessageInfo msg, final int position) {
        ...
        String customData =  msg.getExtra()+"";
        if(!StringUtils.isEmpty(customData)){
            msg_body_tv.setVisibility(View.VISIBLE);
            TUIKitLog.e("MessageAudioHolder  ", "customData = " + customData);
            msg_body_tv.setText(customData);
        }else {
            msg_body_tv.setVisibility(View.GONE);
        }
        ...
        ViewGroup.LayoutParams audioParams = audioContentView.getLayoutParams();
        ...
        audioContentView.setLayoutParams(audioParams);
        audioTimeText.setText(duration + "''");
        audioContentView.setOnClickListener(new View.OnClickListener() {
            @Override
